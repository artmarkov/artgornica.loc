...
--
-- Хост: localhost:3306
-- Время создания: Янв 24 2019 г., 00:33
...
(5, 1, 1, 3, 1548407700, 1548418500, '111', 1000, 0, 1547488584, 1548251729),
(6, 1, 3, 1, 1548486000, 1548497700, 'Расписание', 0, 0, 1547488714, 1548251793),
...
('bd', 'admin-menu', '/db', 'settings', '', 0, 36, 1544790630, 1544790676, 1, 1),
('blog', 'main-menu', '/site/blog', '', '', 0, 4, 1544699051, 1544699051, 1, 1),
('calendar', 'admin-menu', '/event/schedule/fullcalendar', 'event', '', 0, 24, 1547119882, 1547328215, 1, 1),
...
('event', 'admin-menu', '', '', 'calendar', 0, 22, 1546691552, 1546807186, 1, 1),
('event-item', 'admin-menu', '/event/default/index', 'event', '', 0, 26, 1546691606, 1547547597, 1, 1),
('event-methods', 'admin-menu', '/event/methods/index', 'event', '', 0, 30, 1546691818, 1546806941, 1, 1),
('event-place', 'admin-menu', '/event/place/index', 'event', '', 0, 27, 1546691945, 1546807290, 1, 1),
('event-practice', 'admin-menu', '/event/practice/index', 'event', '', 0, 29, 1546691867, 1546806955, 1, 1),
('event-programm', 'admin-menu', '/event/programm/index', 'event', '', 0, 25, 1546691999, 1546691999, 1, 1),
('event-schedule', 'admin-menu', '/event/schedule/index', 'event', '', 0, 23, 1546692074, 1546807163, 1, 1),
('event-vid', 'admin-menu', '/event/vid/index', 'event', '', 0, 28, 1546691902, 1546691902, 1, 1),
('image-settings', 'admin-menu', '/media/default/settings', 'settings', NULL, 0, 34, NULL, NULL, 1, NULL),
('landing-page', 'admin-menu', '', '', 'sliders', 0, 20, 1548271267, 1548271267, 1, 1),
...
('revolution-sliders', 'admin-menu', '/slider/default/index', 'landing-page', '', 0, 21, 1548269000, 1548276285, 1, 1),
('seo', 'admin-menu', '/seo/default/index', '', 'line-chart', 0, 18, NULL, NULL, 1, NULL),
('settings', 'admin-menu', NULL, '', 'cog', 0, 31, NULL, NULL, 1, NULL),
('settings-cache', 'admin-menu', '/settings/cache/flush', 'settings', NULL, 0, 37, NULL, NULL, 1, NULL),
('settings-general', 'admin-menu', '/settings/default/index', 'settings', NULL, 0, 32, NULL, NULL, 1, NULL),
('settings-reading', 'admin-menu', '/settings/reading/index', 'settings', NULL, 0, 33, NULL, NULL, 1, NULL),
('settings-translations', 'admin-menu', '/translation/default/index', 'settings', NULL, 0, 35, NULL, NULL, 1, NULL),
...
(85, 'revolution-sliders', 'ru', 'Топ-слайдер'),
(86, 'landing-page', 'ru', 'Landing Page');
...
(337, 'yee/landing', 'Learn more...', 0),
(338, 'yee', 'Leave a review...', 0),
(339, 'yee', 'Subscribe to', 0),
(340, 'yee/landing', 'Sign up for class', 0),
(341, 'yee/landing', 'Make an appointment', 0),
(342, 'yee', 'Sign up...', 0),
(343, 'yee', 'Contacts', 0),
(344, 'yee/post', 'Main', 0),
(345, 'yee', 'Main On', 0),
...
(418, 'yee/landing', 'Slide Image', 0),
(419, 'yee/landing', 'Banner Top', 0),
(420, 'yee/landing', 'Banner Middle', 0),
(421, 'yee/landing', 'Banner Url', 0),
(422, 'yee/landing', 'Btn Icon', 0),
(423, 'yee/landing', 'Btn Name', 0),
(424, 'yee/landing', 'Btn Class', 0),
(425, 'yee', 'Sort', 0);
...
(4, 'post_4', 3, 1, 1, '/uploads/2018/12/fishermen-1-400x300.jpg', 1533254400, 1544889352, 1546000671, 1, 1, 2, 'post', 'main', 1),
...
--
-- Структура таблицы `revolution_slider`
--

CREATE TABLE `revolution_slider` (
  `id` int(8) NOT NULL,
...
--
-- Дамп данных таблицы `revolution_slider`
--

INSERT INTO `revolution_slider` (`id`, `slide_image`, `banner_top`, `banner_middle`, `url`, `btn_icon`, `btn_name`, `btn_class`, `status`, `sort`) VALUES
(1, '../frontend/web/images/forest-3119826_1920.jpg', 'Жизнь - это счастье!', 'Любовь к жизни, осознанная жизнь <br/> дают ощущение счастья!', '/site/contact', 'fa fa-chevron-circle-right', 'Sign up for class', 'btn btn-primary btn-lg', 1, 0),
(2, '../frontend/web/images/wallpaper-1492818_1920.jpg', 'Позитивный мир начинается с себя!', 'В нашем подсознании скрыта сила,<br/>способная перевернуть мир.', '/site/contact', '', 'Make an appointment', 'btn btn-default btn-lg', 1, 0),
(3, '../frontend/web/images/sunset-silhouette-2081796_1920.jpg', 'Станьте творцом своей жизни!', 'Любите и проявляйте себя. <br/> Сделайте это прямо сейчас!', '/site/blog', '', 'Learn more...', 'btn btn-info btn-lg', 1, 0);
...
--
-- Индексы таблицы `revolution_slider`
--
ALTER TABLE `revolution_slider`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `revolution_slider`
--
ALTER TABLE `revolution_slider`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
