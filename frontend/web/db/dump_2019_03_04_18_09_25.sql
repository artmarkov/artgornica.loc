...
CREATE TABLE `event_item` (
  ...
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Состав программы';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item` VALUES (1,'ОБЩЕСТВО В МИНИАТЮРЕ или \"Как выстраивать доверительные отношения!\"','<p>Курс направлен на раскрытие себя через рисунок, за счет познания своего внутреннего мира и внутреннего мира других участников встреч, с помощью методов арт-терапии.</p>','',1,1546696357,1551694352),(2,'МИР ДЕТСКИХ ВОСПОМИНАНИЙ','111','',2,1546898212,1547556565),(3,'Марафон прощания Обид','Занятие','',4,1546898549,1551045485),(4,'УНИКАЛЬНЫЙ ВНУТРЕННИЙ МИР','333','',3,1546898785,1547670430);
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='связь n:n событий и практик';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_practice` VALUES (2,1,1),(3,2,2),(4,2,6),(13,4,2),(15,4,3),(16,4,1),(17,3,2),(21,1,5);
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='Связь n:n программы с занятиями';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_programm` VALUES (1,1,1,3,3048,2),(2,1,2,2,1000,1),(17,2,3,5,5555,2),(19,1,4,2,2000,3),(20,1,3,45,45,4),(22,2,2,12,12,1);
...
CREATE TABLE `event_item_programm_practice` (
  ...
  KEY `practice_id` (`practice_id`),
  CONSTRAINT `event_item_programm_practice_ibfk_1` FOREIGN KEY (`item_programm_id`) REFERENCES `event_item_programm` (`id`),
  CONSTRAINT `event_item_programm_practice_ibfk_2` FOREIGN KEY (`practice_id`) REFERENCES `event_item_practice` (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Программа занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_programm` VALUES (1,2,'Программа 30 встреч','111','',1547040720,1547979181),(2,1,'Инд Программа','Программа','',1547153697,1548228832);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Расписание занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_schedule` VALUES (3,1,2,2,1555747200,1555848000,'',5,0,1547313715,1551045816),(5,1,1,3,1551780000,1551795000,'111',1000,0,1547488584,1551693962),(6,1,3,1,1555250400,1555257600,'Расписание',0,0,1547488714,1551045656),(8,1,4,3,1551693600,1551702300,'',2000,0,1551046340,1551693958),(9,1,4,2,1551699900,1551708000,NULL,0,0,1551293702,1551693960);
...
INSERT INTO `event_schedule_users` VALUES (6,3,2),(25,6,2),(31,5,2),(32,6,1),(33,9,1);
...
INSERT INTO `event_vid` VALUES (1,0,'Индивидуальное консультирование','\n		',1546708700),(2,1,'Психологическая работа в группе','',1546708966);
...
INSERT INTO `media_album_lang` VALUES (1,1,'ru','Личное фото',''),(2,2,'ru','Фото на главной','Карусель на главной'),(3,3,'ru','Фоны для УТП','Для параллакса на главной'),(4,4,'ru','Фоны для Revolution Slider','На главной слайдер'),(5,5,'ru','Фото Посты Therapy Travel',''),(6,6,'ru','Фото Посты Artterapy',''),(7,7,'ru','Фото Посты Psychology',''),(8,8,'ru','Фото Мероприятия','');
...
INSERT INTO `menu_link` VALUES ('about','main-menu','/site/about','','',1,1,NULL,1544698568,1,1),('active_pages','admin-menu','/section/default/index','landing-page','',0,21,1550236114,1550236114,1,1),('bd','admin-menu','/db','settings','',0,44,1544790630,1544790676,1,1),('blog','main-menu','/site/blog','','',0,4,1544699051,1544699051,1,1),('calendar','admin-menu','/event/schedule/fullcalendar','event','',0,32,1547119882,1547328215,1,1),('carousel','admin-menu','/section/carousel/index','landing-page','',0,24,1548703398,1548703398,1,1),('comment','admin-menu','/comment/default/index','','comment',0,10,NULL,NULL,1,NULL),('consult','main-menu','/consult','','',0,3,1545151400,1545151452,1,1),('contact','main-menu','/site/contact','',NULL,1,5,NULL,NULL,1,NULL),('contact-users','admin-menu','/contact/default/index','','users',0,19,1545854511,1545854531,1,1),('dashboard','admin-menu','/','','th',0,0,NULL,NULL,1,NULL),('eav-attribute','admin-menu','/eav/attribute/index','eav',NULL,0,18,NULL,NULL,1,NULL),('eav-eav','admin-menu','/eav/default/index','eav',NULL,0,17,NULL,NULL,1,NULL),('eav-model','admin-menu','/eav/entity-model/index','eav',NULL,0,20,NULL,NULL,1,NULL),('eav-option','admin-menu','/eav/attribute-option/index','eav',NULL,0,19,NULL,NULL,1,NULL),('eav-type','admin-menu','/eav/attribute-type/index','eav',NULL,0,21,NULL,NULL,1,NULL),('event','admin-menu','','','calendar',0,30,1546691552,1546807186,1,1),('event-item','admin-menu','/event/default/index','event','',0,34,1546691606,1547547597,1,1),('event-methods','admin-menu','/event/methods/index','event','',0,38,1546691818,1546806941,1,1),('event-place','admin-menu','/event/place/index','event','',0,35,1546691945,1546807290,1,1),('event-practice','admin-menu','/event/practice/index','event','',0,37,1546691867,1546806955,1,1),('event-programm','admin-menu','/event/programm/index','event','',0,33,1546691999,1546691999,1,1),('event-schedule','admin-menu','/event/schedule/index','event','',0,31,1546692074,1546807163,1,1),('event-vid','admin-menu','/event/vid/index','event','',0,36,1546691902,1546691902,1,1),('feedback','admin-menu','/section/feedback/index','landing-page','',0,29,1549635790,1549635790,1,1),('image-settings','admin-menu','/media/default/settings','settings',NULL,0,42,NULL,NULL,1,NULL),('landing-page','admin-menu','','','sun-o',0,20,1548271267,1548365112,1,1),('main','main-menu','/','','home',1,0,1551293265,1551293512,1,1),('media','admin-menu',NULL,'','image',0,6,NULL,NULL,1,NULL),('media-album','admin-menu','/media/album/index','media',NULL,0,8,NULL,NULL,1,NULL),('media-category','admin-menu','/media/category/index','media',NULL,0,9,NULL,NULL,1,NULL),('media-media','admin-menu','/media/default/index','media',NULL,0,7,NULL,NULL,1,NULL),('menu','admin-menu','/menu/default/index','','align-justify',0,11,NULL,NULL,1,NULL),('menu_portfolio','admin-menu','/portfolio/menu/index','portfolio_main','',0,27,1548922544,1548922544,1,1),('page','admin-menu','/page/default/index','','file',0,1,NULL,NULL,1,NULL),('paralax','admin-menu','/section/parallax/index','landing-page','',0,23,1548333227,1548340198,1,1),('portfolio','admin-menu','/portfolio/default/index','portfolio_main','',0,26,1548880921,1548923248,1,1),('portfolio_category','admin-menu','/portfolio/category/index','portfolio_main','',0,28,1548880996,1549574144,1,1),('portfolio_main','admin-menu','','landing-page','',0,25,1548922592,1550575345,1,1),('post','admin-menu','','','pencil',0,2,NULL,1545053615,1,1),('post-category','admin-menu','/post/category/index','post',NULL,0,5,NULL,NULL,1,NULL),('post-post','admin-menu','/post/default/index','post','',0,3,NULL,1545053627,1,1),('post-tag','admin-menu','/post/tag/index','post','',0,4,NULL,1544638544,1,1),('revolution-sliders','admin-menu','/section/slides/index','landing-page','',0,22,1548269000,1549572851,1,1),('seo','admin-menu','/seo/default/index','','line-chart',0,18,NULL,NULL,1,NULL),('settings','admin-menu',NULL,'','cog',0,39,NULL,NULL,1,NULL),('settings-cache','admin-menu','/settings/cache/flush','settings',NULL,0,45,NULL,NULL,1,NULL),('settings-general','admin-menu','/settings/default/index','settings',NULL,0,40,NULL,NULL,1,NULL),('settings-reading','admin-menu','/settings/reading/index','settings',NULL,0,41,NULL,NULL,1,NULL),('settings-translations','admin-menu','/translation/default/index','settings',NULL,0,43,NULL,NULL,1,NULL),('test-page','main-menu','/site/author-course','','',1,2,NULL,1545840778,1,1),('user','admin-menu',NULL,'','user',0,12,NULL,NULL,1,NULL),('user-groups','admin-menu','/user/permission-groups/index','user',NULL,0,16,NULL,NULL,1,NULL),('user-log','admin-menu','/user/visit-log/index','user',NULL,0,17,NULL,NULL,1,NULL),('user-permission','admin-menu','/user/permission/index','user',NULL,0,15,NULL,NULL,1,NULL),('user-role','admin-menu','/user/role/index','user',NULL,0,14,NULL,NULL,1,NULL),('user-user','admin-menu','/user/default/index','user',NULL,0,13,NULL,NULL,1,NULL);
...
INSERT INTO `portfolio_items` VALUES (1,6,'/uploads/2019/02/solar-eclipse-832x468.jpg',NULL,'/uploads/2019/02/solar-eclipse-1280x720.jpg',1,1549222945,1551298872),(2,3,'/uploads/2019/02/sunset-silhouette-832x468.jpg',NULL,'/uploads/2019/02/sunset-silhouette-1280x720.jpg',1,1549226874,1549627660),(3,5,'/uploads/2019/02/forest-832x468.jpg',NULL,'/zhizn_puteshestvie',1,1549567830,1551298715);
...
INSERT INTO `portfolio_menu` VALUES (2,'Фотография','',1,0,1548925719,1549193888),(3,'Видео','',1,0,1549193879,1549193879),(4,'Блог','',1,0,1549194157,1551298921),(5,'Арт-терапия изображения','',1,0,1549194416,1549194677);
...
INSERT INTO `portfolio_menu_category` VALUES (2,2,3),(4,3,4),(5,4,5),(9,5,6);
...
INSERT INTO `post_category` VALUES (1,'root',0,1538934053,1545127573,NULL,1,1,26,0),(2,'celi_samorealizacia',1,1538934056,1550604759,1,2,4,5,1),(3,'resursy_motivacia',1,1544781484,1550604774,1,2,6,7,1),(4,'momenty_vremeni',0,1545053817,1550604724,1,2,8,9,1),(5,'mysli_emotsii',0,1550604077,1550604370,2,2,16,17,1),(6,'obschestvo_miniatyure',0,1550604652,1550607766,2,2,10,11,1),(8,'unikalnyy_vnutrenniy_mir',0,1550605001,1550605001,2,2,14,15,1),(9,'kak_stat_schastlivym',0,1550605089,1550605089,2,2,2,3,1),(11,'mir_detstva',0,1550605771,1550941679,2,2,12,13,1),(16,'artterapiya_21vek',0,1550607322,1550607322,2,2,22,23,1),(17,'travel_therapy',0,1550655363,1550655363,2,2,24,25,1),(18,'iskusstvo_proscheniya',0,1550941331,1550941331,2,2,18,19,1),(19,'muzhchina_zhenschina',0,1550941578,1550941578,2,2,20,21,1);
...
CREATE TABLE `section_block` (
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`),
  CONSTRAINT `section_block_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `section_item` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `section_item` (
  ...
  CONSTRAINT `section_item_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `section_page` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `section_page` (
  ...
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Страницы sms';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `section_page` VALUES (1,'1 str','1-str',1,1,1551616611,1551616611),(2,'2 str','2-str',1,2,1551616629,1551616629),(3,'3 str','3-str',1,4,1551616645,1551616645),(4,'4 str','4-str',1,3,1551616652,1551616652);
...
-- Dump completed on 2019-03-04 18:09:27
