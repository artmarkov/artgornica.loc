...
--
-- Хост: localhost:3306
-- Время создания: Фев 04 2019 г., 00:24
...
(1, NULL, 'twilight-1.jpg', 'image/jpeg', '/uploads/2019/02/twilight-1.jpg', '319943', 'a:4:{s:5:\"small\";s:39:\"/uploads/2019/02/twilight-1-256x144.jpg\";s:6:\"medium\";s:39:\"/uploads/2019/02/twilight-1-640x360.jpg\";s:5:\"large\";s:40:\"/uploads/2019/02/twilight-1-1280x720.jpg\";s:5:\"great\";s:41:\"/uploads/2019/02/twilight-1-1920x1080.jpg\";}', 1549222927, 1549222929, 1, 1);
...
(1, 1, 'ru', 'twilight-1.jpg', 'twilight-1.jpg', NULL);
...
(1, 3, '/uploads/2019/02/twilight-1-640x360.jpg', NULL, '/uploads/2019/02/twilight-1-1280x720.jpg', 1, 1549222945, 1549228810),
(2, 3, '/uploads/2019/02/twilight-1-640x360.jpg', NULL, '/uploads/2019/02/twilight-1-1280x720.jpg', 1, 1549226874, 1549228856);
...
(15, 'post_15', 4, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1534291200, 1440763228, 1546002758, 1, 1, 144, 'post', 'main', 1);
...
(1, 'Карусель главная', 'karusel-glavnaia', 'owl-carousel controlls-over', '{\"items\": 1, \"singleItem\": true, \"navigation\": true, \"pagination\": true, \"transitionStyle\":\"fadeUp\"}', 'img-responsive', '555', '311', 1, 1548704519, 1548706099);
...
(1, 'Слайд 1', 'fade', 7, 300, '', '../frontend/web/images/dummy.png', '', '/uploads/2019/02/sunset-silhouette-20817961920-1920x1080.jpg', 'on', '', '', '', 1, 3, 1548582670, 1549114251),
(2, 'Слайд 2', 'fade', 7, 300, '', '../frontend/web/images/dummy.png', '', '/uploads/2019/02/wallpaper-14928181920-1920x1080.jpg', 'on', '', '', '', 1, 2, 1548582670, 1549114011),
(3, 'Слайд 3', 'fade', 7, 300, '', '../frontend/web/images/dummy.png', '', '/uploads/2019/02/forest-31198261920-1920x1080.jpg', 'on', '', '', '', 1, 1, 1548582670, 1549114260),
...
--
-- Ограничения внешнего ключа таблицы `portfolio_items_category`
--
ALTER TABLE `portfolio_items_category`
  ADD CONSTRAINT `portfolio_items_category_ibfk_1` FOREIGN KEY (`items_id`) REFERENCES `portfolio_items` (`id`),
  ADD CONSTRAINT `portfolio_items_category_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `portfolio_category` (`id`);
...
--
-- Ограничения внешнего ключа таблицы `section_slides_layers`
--
ALTER TABLE `section_slides_layers`
  ADD CONSTRAINT `section_slides_layers_ibfk_1` FOREIGN KEY (`slides_id`) REFERENCES `section_slides` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
