...
--
-- Хост: localhost:3306
-- Время создания: Янв 27 2019 г., 22:05
...
(3, 1, 2, 2, 1548315000, 1548326700, '', 5, 0, 1547313715, 1548251727),
(5, 1, 1, 3, 1548398700, 1548409500, '111', 1000, 0, 1547488584, 1548365233),
(6, 1, 3, 1, 1548482400, 1548494100, 'Расписание', 0, 0, 1547488714, 1548365234),
(7, 1, 2, 2, 1548232200, 1548243900, NULL, 0, 0, 1548251754, 1548251754);
...
(1, '1545120447_096KGq.jpg', 'Post', 15, NULL, 0, 'image', NULL, 'http://artgornica.loc/uploads/images/Post/1545120447_096KGq.jpg', 221353),
(2, '1545120480_RLBCs6.jpg', 'Post', 15, NULL, 1, 'image', NULL, 'http://artgornica.loc/uploads/images/Post/1545120480_RLBCs6.jpg', 152305);
...
('bd', 'admin-menu', '/db', 'settings', '', 0, 37, 1544790630, 1544790676, 1, 1),
('blog', 'main-menu', '/site/blog', '', '', 0, 4, 1544699051, 1544699051, 1, 1),
('calendar', 'admin-menu', '/event/schedule/fullcalendar', 'event', '', 0, 25, 1547119882, 1547328215, 1, 1),
...
('event', 'admin-menu', '', '', 'calendar', 0, 23, 1546691552, 1546807186, 1, 1),
('event-item', 'admin-menu', '/event/default/index', 'event', '', 0, 27, 1546691606, 1547547597, 1, 1),
('event-methods', 'admin-menu', '/event/methods/index', 'event', '', 0, 31, 1546691818, 1546806941, 1, 1),
('event-place', 'admin-menu', '/event/place/index', 'event', '', 0, 28, 1546691945, 1546807290, 1, 1),
('event-practice', 'admin-menu', '/event/practice/index', 'event', '', 0, 30, 1546691867, 1546806955, 1, 1),
('event-programm', 'admin-menu', '/event/programm/index', 'event', '', 0, 26, 1546691999, 1546691999, 1, 1),
('event-schedule', 'admin-menu', '/event/schedule/index', 'event', '', 0, 24, 1546692074, 1546807163, 1, 1),
('event-vid', 'admin-menu', '/event/vid/index', 'event', '', 0, 29, 1546691902, 1546691902, 1, 1),
('image-settings', 'admin-menu', '/media/default/settings', 'settings', NULL, 0, 35, NULL, NULL, 1, NULL),
...
('settings', 'admin-menu', NULL, '', 'cog', 0, 32, NULL, NULL, 1, NULL),
('settings-cache', 'admin-menu', '/settings/cache/flush', 'settings', NULL, 0, 38, NULL, NULL, 1, NULL),
('settings-general', 'admin-menu', '/settings/default/index', 'settings', NULL, 0, 33, NULL, NULL, 1, NULL),
('settings-reading', 'admin-menu', '/settings/reading/index', 'settings', NULL, 0, 34, NULL, NULL, 1, NULL),
('settings-translations', 'admin-menu', '/translation/default/index', 'settings', NULL, 0, 36, NULL, NULL, 1, NULL),
...
(9, 'post_9', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533686400, 1440763228, 1545036435, 1, 1, 1, 'post', 'main', 0),
...
(15, 'post_15', 4, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1534291200, 1440763228, 1546002758, 1, 1, 123, 'post', 'main', 1);
...
INSERT INTO `section_parallax` (`id`, `name`, `bg_color`, `bg_image`, `content_image`, `content`, `countdown`, `countdown_prompt`, `start_timestamp`, `url`, `btn_icon`, `btn_name`, `btn_class`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Позитивный мир  начинается с себя', 'rgb(0, 0, 0)', '../frontend/web/images/tree-736877_1280-1.jpg', '', '<h2>Позитивный мир  <strong>Начинается с себя!</strong></h2>\r\n<p class=\"lead\">\r\n      Сделайте шаг к переменам в своей жизни прямо сейчас!\r\n</p>\r\n<p>\r\nПочувствовать вкус к жизни и найти дорогу к Вашим целям поможет мой авторский курс<br />«30 встреч» -\r\nПуть к Поиску Себя! Благодаря взаимодействию с арт-терапией Вы осознаете, что можно жить без\r\nлишних переживаний! Вы узнаете, как сохранить жизненные силы и где найти ресурсы!\r\n</p>', 0, 'До начала занятия осталось:', 1548367920, '/site/contact', 'fa fa-chevron-circle-right', 'Sign up for class', 'btn btn-primary btn-lg', 1, 0, 1548367883);
...
CREATE TABLE `section_slider` (
  `id` int(8) NOT NULL,
  `slide_image` varchar(127) NOT NULL,
  `banner_top` varchar(127) NOT NULL,
  `banner_middle` varchar(127) NOT NULL,
  `url` varchar(127) NOT NULL,
  `btn_icon` varchar(127) NOT NULL,
  `btn_name` varchar(127) NOT NULL,
  `btn_class` varchar(127) NOT NULL,
...
INSERT INTO `section_slider` (`id`, `slide_image`, `banner_top`, `banner_middle`, `url`, `btn_icon`, `btn_name`, `btn_class`, `status`, `sort`, `created_at`, `updated_at`) VALUES
(1, '../frontend/web/images/forest-3119826_1920.jpg', 'Жизнь - это счастье!', 'Любовь к жизни, осознанная жизнь <br/> дают ощущение счастья!', '/site/contact', 'fa fa-chevron-circle-right', 'Sign up for class', 'btn btn-primary btn-lg', 1, 0, 0, 0),
(2, '../frontend/web/images/wallpaper-1492818_1920.jpg', 'Позитивный мир начинается с себя!', 'В нашем подсознании скрыта сила,<br/>способная перевернуть мир.', '/site/contact', '', 'Make an appointment', 'btn btn-default btn-lg', 1, 0, 0, 0),
(3, '../frontend/web/images/sunset-silhouette-2081796_1920.jpg', 'Станьте творцом своей жизни!', 'Любите и проявляйте себя. <br/> Сделайте это прямо сейчас!', '/site/blog', '', 'Learn more...', 'btn btn-info btn-lg', 1, 0, 0, 1548362955);
