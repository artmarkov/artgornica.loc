...
INSERT INTO `event_group` VALUES (1,1,1,'Первая группа','',1547045378,1547045378);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='связь n:n событий и практик';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_practice` VALUES (1,1,2),(2,1,1),(3,2,2),(4,2,6),(5,3,3),(6,3,4),(10,4,6),(12,4,5),(13,4,2),(14,4,4);
...
CREATE TABLE `event_schedule` (
  ...
  CONSTRAINT `event_schedule_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `event_item` (`id`),
...
INSERT INTO `user` VALUES (1,'admin','','$2y$13$1NSOFxrPUco1qxPEklyjUu28hIEfECTTejllHu2PKAxdaXmsBj6Mi',NULL,'artmarkov@mail.ru',10,0,1546636103,1,NULL,'',1,NULL,'{\"small\":\"\\/uploads\\/avatar\\/avatar_1_1546106724-48x48.jpg\",\"medium \":\"\\/uploads\\/avatar\\/avatar_1_1546106724-96x96.jpg\",\"large\":\"\\/uploads\\/avatar\\/avatar_1_1546106724-144x144.jpg\"}','Артур','Марков',1,4,1971,1,'+79055400746','artmarkov_skype','1111'),(2,'ishanova','yMdSVV0avEq9xO4p7uO4uCuAeAHpizQc','$2y$13$G.6gfVKDmWhQsEQuvv2QmuiT/8VRRViJsr3AmXgsVzUtR25Wo/oG2',NULL,'elenaishanova@mail.ru',10,1545848489,1545901921,0,'::1','',1,NULL,NULL,'Елена','Ишанова',26,11,1978,2,'','',''),(6,'markov_av','DB6oF4FiE-4ERlXTnclkgwN4xJYuUhNR','$2y$13$MdRtxjBZYYDPuiblQ37xdug1eCZzGE.d4NbenwWhWJrNCf6TPvgNC',NULL,'artmarkov-71@yandex.ru',10,1546109689,1546110062,0,'::1','',1,NULL,NULL,'','',NULL,1,NULL,0,'','','');
...
-- Dump completed on 2019-01-09 18:05:36
