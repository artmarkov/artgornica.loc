...
INSERT INTO `event_schedule` VALUES (3,1,2,2,1548315000,1548326700,'',5,0,1547313715,1548251727),(5,1,1,3,1548407700,1548418500,'111',1000,0,1547488584,1548251729),(6,1,3,1,1548486000,1548497700,'Расписание',0,0,1547488714,1548251793),(7,1,2,2,1548232200,1548243900,NULL,0,0,1548251754,1548251754);
...
INSERT INTO `section_slider` VALUES (1,'../frontend/web/images/forest-3119826_1920.jpg','Жизнь - это счастье!','Любовь к жизни, осознанная жизнь <br/> дают ощущение счастья!','/site/contact','fa fa-chevron-circle-right','Sign up for class','btn btn-primary btn-lg',1,0),(2,'../frontend/web/images/wallpaper-1492818_1920.jpg','Позитивный мир начинается с себя!','В нашем подсознании скрыта сила,<br/>способная перевернуть мир.','/site/contact','','Make an appointment','btn btn-default btn-lg',1,0),(3,'../frontend/web/images/sunset-silhouette-2081796_1920.jpg','Станьте творцом своей жизни!','Любите и проявляйте себя. <br/> Сделайте это прямо сейчас!','/site/blog','','Learn more...','btn btn-info btn-lg',1,0);
...
-- Dump completed on 2019-01-24 18:03:55
