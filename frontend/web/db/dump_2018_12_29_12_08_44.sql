...
--
-- Table structure for table `evant_place`
--

DROP TABLE IF EXISTS `evant_place`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `evant_place` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `name` varchar(127) NOT NULL,
...
--
-- Dumping data for table `evant_place`
--

/*!40000 ALTER TABLE `evant_place` DISABLE KEYS */;
/*!40000 ALTER TABLE `evant_place` ENABLE KEYS */;
...
--
-- Table structure for table `event_item_methods`
--

DROP TABLE IF EXISTS `event_item_methods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_item_methods` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `event_item_methods_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `event_item` (`id`),
  CONSTRAINT `event_item_methods_ibfk_2` FOREIGN KEY (`methods_id`) REFERENCES `event_methods` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='связь n:n событий и методов';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `event_item_methods`
--

/*!40000 ALTER TABLE `event_item_methods` DISABLE KEYS */;
/*!40000 ALTER TABLE `event_item_methods` ENABLE KEYS */;
...
CREATE TABLE `event_item_programm` (
  ...
  `prigramm_id` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`),
  KEY `prigramm_id` (`prigramm_id`),
  CONSTRAINT `event_item_programm_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `event_item` (`id`),
  CONSTRAINT `event_item_programm_ibfk_2` FOREIGN KEY (`prigramm_id`) REFERENCES `event_programm` (`id`)
...
CREATE TABLE `event_schedule` (
  ...
  CONSTRAINT `event_schedule_ibfk_2` FOREIGN KEY (`place_id`) REFERENCES `evant_place` (`id`)
...
INSERT INTO `user` VALUES (1,'admin','','$2y$13$wcW.QP1/o32QF45xIaYre./1fm9YtkYH7CGSigDqDbYgA9jEyxcRK',NULL,'artmarkov@mail.ru',10,0,1545848406,1,NULL,'',1,'n67FQzYBO4l5nVQ5FJ2i_qYCoP94Mqxl_1545847390',NULL,'Артур','Марков',1,4,1971,1,'+79055400746','artmarkov_skype',''),(2,'ishanova','yMdSVV0avEq9xO4p7uO4uCuAeAHpizQc','$2y$13$G.6gfVKDmWhQsEQuvv2QmuiT/8VRRViJsr3AmXgsVzUtR25Wo/oG2',NULL,'elenaishanova@mail.ru',10,1545848489,1545901921,0,'::1','',1,NULL,NULL,'Елена','Ишанова',26,11,1978,2,'','','');
...
-- Dump completed on 2018-12-29 12:08:45
