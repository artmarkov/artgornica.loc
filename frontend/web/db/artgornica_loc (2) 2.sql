...
--
-- Хост: localhost:3306
-- Время создания: Янв 29 2019 г., 01:49
...
(3, '1548705959_gNuNuR.jpg', 'Carousel', 1, NULL, 0, 'image', NULL, 'http://artgornica.loc/uploads/images/Carousel/1548705959_gNuNuR.jpg', 15489);
...
('bd', 'admin-menu', '/db', 'settings', '', 0, 38, 1544790630, 1544790676, 1, 1),
('blog', 'main-menu', '/site/blog', '', '', 0, 4, 1544699051, 1544699051, 1, 1),
('calendar', 'admin-menu', '/event/schedule/fullcalendar', 'event', '', 0, 26, 1547119882, 1547328215, 1, 1),
...
('event', 'admin-menu', '', '', 'calendar', 0, 24, 1546691552, 1546807186, 1, 1),
('event-item', 'admin-menu', '/event/default/index', 'event', '', 0, 28, 1546691606, 1547547597, 1, 1),
('event-methods', 'admin-menu', '/event/methods/index', 'event', '', 0, 32, 1546691818, 1546806941, 1, 1),
('event-place', 'admin-menu', '/event/place/index', 'event', '', 0, 29, 1546691945, 1546807290, 1, 1),
('event-practice', 'admin-menu', '/event/practice/index', 'event', '', 0, 31, 1546691867, 1546806955, 1, 1),
('event-programm', 'admin-menu', '/event/programm/index', 'event', '', 0, 27, 1546691999, 1546691999, 1, 1),
('event-schedule', 'admin-menu', '/event/schedule/index', 'event', '', 0, 25, 1546692074, 1546807163, 1, 1),
('event-vid', 'admin-menu', '/event/vid/index', 'event', '', 0, 30, 1546691902, 1546691902, 1, 1),
('image-settings', 'admin-menu', '/media/default/settings', 'settings', NULL, 0, 36, NULL, NULL, 1, NULL),
...
('settings', 'admin-menu', NULL, '', 'cog', 0, 33, NULL, NULL, 1, NULL),
('settings-cache', 'admin-menu', '/settings/cache/flush', 'settings', NULL, 0, 39, NULL, NULL, 1, NULL),
('settings-general', 'admin-menu', '/settings/default/index', 'settings', NULL, 0, 34, NULL, NULL, 1, NULL),
('settings-reading', 'admin-menu', '/settings/reading/index', 'settings', NULL, 0, 35, NULL, NULL, 1, NULL),
('settings-translations', 'admin-menu', '/translation/default/index', 'settings', NULL, 0, 37, NULL, NULL, 1, NULL),
