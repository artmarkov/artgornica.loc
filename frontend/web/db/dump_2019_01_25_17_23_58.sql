...
INSERT INTO `event_schedule` VALUES (3,1,2,2,1548315000,1548326700,'',5,0,1547313715,1548251727),(5,1,1,3,1548398700,1548409500,'111',1000,0,1547488584,1548365233),(6,1,3,1,1548482400,1548494100,'Расписание',0,0,1547488714,1548365234),(7,1,2,2,1548232200,1548243900,NULL,0,0,1548251754,1548251754);
...
INSERT INTO `menu_link` VALUES ('about','main-menu','/site/about','','',1,1,NULL,1544698568,1,1),('bd','admin-menu','/db','settings','',0,37,1544790630,1544790676,1,1),('blog','main-menu','/site/blog','','',0,4,1544699051,1544699051,1,1),('calendar','admin-menu','/event/schedule/fullcalendar','event','',0,25,1547119882,1547328215,1,1),('comment','admin-menu','/comment/default/index','','comment',0,10,NULL,NULL,1,NULL),('consult','main-menu','/consult','','',0,3,1545151400,1545151452,1,1),('contact','main-menu','/site/contact','',NULL,1,6,NULL,NULL,1,NULL),('contact-users','admin-menu','/contact/default/index','','users',0,19,1545854511,1545854531,1,1),('dashboard','admin-menu','/','','th',0,0,NULL,NULL,1,NULL),('eav-attribute','admin-menu','/eav/attribute/index','eav',NULL,0,18,NULL,NULL,1,NULL),('eav-eav','admin-menu','/eav/default/index','eav',NULL,0,17,NULL,NULL,1,NULL),('eav-model','admin-menu','/eav/entity-model/index','eav',NULL,0,20,NULL,NULL,1,NULL),('eav-option','admin-menu','/eav/attribute-option/index','eav',NULL,0,19,NULL,NULL,1,NULL),('eav-type','admin-menu','/eav/attribute-type/index','eav',NULL,0,21,NULL,NULL,1,NULL),('event','admin-menu','','','calendar',0,23,1546691552,1546807186,1,1),('event-item','admin-menu','/event/default/index','event','',0,27,1546691606,1547547597,1,1),('event-methods','admin-menu','/event/methods/index','event','',0,31,1546691818,1546806941,1,1),('event-place','admin-menu','/event/place/index','event','',0,28,1546691945,1546807290,1,1),('event-practice','admin-menu','/event/practice/index','event','',0,30,1546691867,1546806955,1,1),('event-programm','admin-menu','/event/programm/index','event','',0,26,1546691999,1546691999,1,1),('event-schedule','admin-menu','/event/schedule/index','event','',0,24,1546692074,1546807163,1,1),('event-vid','admin-menu','/event/vid/index','event','',0,29,1546691902,1546691902,1,1),('image-settings','admin-menu','/media/default/settings','settings',NULL,0,35,NULL,NULL,1,NULL),('landing-page','admin-menu','','','sun-o',0,20,1548271267,1548365112,1,1),('media','admin-menu',NULL,'','image',0,6,NULL,NULL,1,NULL),('media-album','admin-menu','/media/album/index','media',NULL,0,8,NULL,NULL,1,NULL),('media-category','admin-menu','/media/category/index','media',NULL,0,9,NULL,NULL,1,NULL),('media-media','admin-menu','/media/default/index','media',NULL,0,7,NULL,NULL,1,NULL),('menu','admin-menu','/menu/default/index','','align-justify',0,11,NULL,NULL,1,NULL),('page','admin-menu','/page/default/index','','file',0,1,NULL,NULL,1,NULL),('paralax','admin-menu','/section/parallax/index','landing-page','',0,22,1548333227,1548340198,1,1),('post','admin-menu','','','pencil',0,2,NULL,1545053615,1,1),('post-category','admin-menu','/post/category/index','post',NULL,0,5,NULL,NULL,1,NULL),('post-post','admin-menu','/post/default/index','post','',0,3,NULL,1545053627,1,1),('post-tag','admin-menu','/post/tag/index','post','',0,4,NULL,1544638544,1,1),('revolution-sliders','admin-menu','/section/slider/index','landing-page','',0,21,1548269000,1548365168,1,1),('seo','admin-menu','/seo/default/index','','line-chart',0,18,NULL,NULL,1,NULL),('settings','admin-menu',NULL,'','cog',0,32,NULL,NULL,1,NULL),('settings-cache','admin-menu','/settings/cache/flush','settings',NULL,0,38,NULL,NULL,1,NULL),('settings-general','admin-menu','/settings/default/index','settings',NULL,0,33,NULL,NULL,1,NULL),('settings-reading','admin-menu','/settings/reading/index','settings',NULL,0,34,NULL,NULL,1,NULL),('settings-translations','admin-menu','/translation/default/index','settings',NULL,0,36,NULL,NULL,1,NULL),('test-page','main-menu','/site/author-course','','',1,2,NULL,1545840778,1,1),('user','admin-menu',NULL,'','user',0,12,NULL,NULL,1,NULL),('user-groups','admin-menu','/user/permission-groups/index','user',NULL,0,16,NULL,NULL,1,NULL),('user-log','admin-menu','/user/visit-log/index','user',NULL,0,17,NULL,NULL,1,NULL),('user-permission','admin-menu','/user/permission/index','user',NULL,0,15,NULL,NULL,1,NULL),('user-role','admin-menu','/user/role/index','user',NULL,0,14,NULL,NULL,1,NULL),('user-user','admin-menu','/user/default/index','user',NULL,0,13,NULL,NULL,1,NULL);
...
--
-- Dumping data for table `section_slider`
--

/*!40000 ALTER TABLE `section_slider` DISABLE KEYS */;
INSERT INTO `section_slider` VALUES (1,'../frontend/web/images/forest-3119826_1920.jpg','Жизнь - это счастье!','Любовь к жизни, осознанная жизнь <br/> дают ощущение счастья!','/site/contact','fa fa-chevron-circle-right','Sign up for class','btn btn-primary btn-lg',1,0,0,0),(2,'../frontend/web/images/wallpaper-1492818_1920.jpg','Позитивный мир начинается с себя!','В нашем подсознании скрыта сила,<br/>способная перевернуть мир.','/site/contact','','Make an appointment','btn btn-default btn-lg',1,0,0,0),(3,'../frontend/web/images/sunset-silhouette-2081796_1920.jpg','Станьте творцом своей жизни!','Любите и проявляйте себя. <br/> Сделайте это прямо сейчас!','/site/blog','','Learn more...','btn btn-info btn-lg',1,0,0,1548362955);
/*!40000 ALTER TABLE `section_slider` ENABLE KEYS */;
...
-- Dump completed on 2019-01-25 17:23:59
