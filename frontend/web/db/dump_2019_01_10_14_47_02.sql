...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Группы арттерапии';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_group` VALUES (1,1,1,'Первая группа','',1547045378,1547105028);
...
INSERT INTO `event_group_users` VALUES (1,1,2),(4,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Связь n:n программы с занятиями';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_programm` VALUES (1,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Программа занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_programm` VALUES (1,2,'Программа 30 встреч','',1547040720,1547042980);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Расписание занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_schedule` VALUES (1,1,1,1547116200,1547119800,'','1500',0);
...
-- Dump completed on 2019-01-10 17:47:03
