...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='связь n:n событий и практик';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_practice` VALUES (1,1,2),(2,1,1),(3,2,2),(4,2,6),(13,4,2),(15,4,3),(16,4,1);
...
INSERT INTO `event_programm` VALUES (1,2,'Программа 30 встреч','111',1547040720,1547979181),(2,1,'Инд Программа','',1547153697,1547754731);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Расписание занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_schedule` VALUES (3,1,2,2,1548063900,1548075600,'',5,0,1547313715,1548081983),(5,1,1,3,1548062100,1548072900,'111',1000,0,1547488584,1548063066),(6,2,3,1,1548055800,1548067500,'',0,0,1547488714,1548063052);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='связь n:n событий в расписании и практик';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_schedule_practice` VALUES (6,6,3),(7,6,4),(8,5,1),(11,5,2),(12,3,6);
...
-- Dump completed on 2019-01-21 18:11:43
