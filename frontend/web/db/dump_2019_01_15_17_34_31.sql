...
CREATE TABLE `event_item` (
  ...
  `qty_meetings` int(3) NOT NULL DEFAULT '1',
...
INSERT INTO `event_item` VALUES (1,2,'ОБЩЕСТВО В МИНИАТЮРЕ или \"Как выстраивать доверительные отношения!\"','Курс  направлен на раскрытие себя через рисунок, за счет познания своего внутреннего мира и внутреннего мира других участников встреч, с помощью методов арт-терапии.',1,0,1546696357,1546895768),(2,2,'МИР ДЕТСКИХ ВОСПОМИНАНИЙ','111',2,1400,1546898212,1547556565),(3,1,'КРЕАТИВНОСТЬ или \"Мой творческий потенциал!\"','222',1,0,1546898549,1546898549),(4,2,'УНИКАЛЬНЫЙ ВНУТРЕННИЙ МИР','333',3,2000,1546898785,1547547551);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='Расписание занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_schedule` VALUES (1,3,4,1,1547532000,1547540100,'23456',1500,0,1547116200,1547478995),(2,3,4,1,1547625000,1547631900,'111',1000,0,1547214300,1547536731),(3,2,3,2,1547531100,1547542800,'',5,0,1547313715,1547503214),(5,1,1,3,1547528400,1547539200,'111',1000,0,1547488584,1547503117),(6,1,1,2,1547613000,1547624700,'',1,0,1547488714,1547559221);
...
-- Dump completed on 2019-01-15 17:34:32
