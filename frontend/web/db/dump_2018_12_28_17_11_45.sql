...
CREATE TABLE `event_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Категории занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event_item` (
  ...
  `qty` smallint(2) NOT NULL COMMENT 'кол-во занятий',
  `created_at` int(11) NOT NULL,
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `event_category_id` (`category_id`),
  CONSTRAINT `event_item_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `event_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Мероприятия';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-12-28 17:11:47
