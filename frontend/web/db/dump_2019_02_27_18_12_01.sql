...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='связь n:n событий и практик';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_practice` VALUES (1,1,2),(2,1,1),(3,2,2),(4,2,6),(13,4,2),(15,4,3),(16,4,1),(17,3,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='Связь n:n программы с занятиями';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_programm` VALUES (1,1,1,3,3047),(2,1,2,2,1000),(3,1,3,1,500),(17,2,3,5,5555),(19,1,4,2,2000);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Расписание занятий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_schedule` VALUES (3,1,2,2,1555747200,1555848000,'',5,0,1547313715,1551045816),(5,1,1,3,1553940000,1553955000,'111',1000,0,1547488584,1551045769),(6,1,3,1,1555250400,1555257600,'Расписание',0,0,1547488714,1551045656),(8,1,4,3,1551177900,1551187500,'',2000,0,1551046340,1551275464);
/*!40000 ALTER TABLE `event_schedule` ENABLE KEYS */;

--
-- Table structure for table `event_schedule_practice`
--

DROP TABLE IF EXISTS `event_schedule_practice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_schedule_practice` (
  ...
  `practice_id` int(8) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `item_id` (`schedule_id`),
  KEY `practice_id` (`practice_id`),
  CONSTRAINT `event_schedule_practice_ibfk_1` FOREIGN KEY (`practice_id`) REFERENCES `event_practice` (`id`),
  CONSTRAINT `event_schedule_practice_ibfk_2` FOREIGN KEY (`schedule_id`) REFERENCES `event_schedule` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='связь n:n событий в расписании и практик';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `event_schedule_practice`
--

/*!40000 ALTER TABLE `event_schedule_practice` DISABLE KEYS */;
INSERT INTO `event_schedule_practice` VALUES (8,5,1),(11,5,2),(12,3,6),(13,6,2),(16,8,3);
/*!40000 ALTER TABLE `event_schedule_practice` ENABLE KEYS */;
...
INSERT INTO `event_schedule_users` VALUES (6,3,2),(25,6,2),(31,5,2),(32,6,1);
...
INSERT INTO `section_page` VALUES (1,'Обо мне','about_me',1,1550235943,1550241633);
...
-- Dump completed on 2019-02-27 18:12:03
