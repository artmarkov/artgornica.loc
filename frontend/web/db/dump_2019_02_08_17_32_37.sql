...
INSERT INTO `event_schedule` VALUES (3,1,2,2,1549527300,1549539000,'',5,0,1547313715,1549563367),(5,1,1,3,1549607400,1549618200,'111',1000,0,1547488584,1549563370),(6,1,3,1,1549517400,1549529100,'Расписание',0,0,1547488714,1549563368),(7,1,2,2,1549611900,1549623600,NULL,0,0,1548251754,1549563372);
...
INSERT INTO `media_lang` VALUES (7,7,'ru','tree-cat.jpg','tree-cat.jpg',''),(8,8,'ru','forest.jpg','forest.jpg',''),(9,9,'ru','sunset-silhouette.jpg','sunset-silhouette.jpg',''),(10,10,'ru','solar-eclipse.jpg','solar-eclipse.jpg',''),(11,11,'ru','textslider.jpg','textslider.jpg','');
...
INSERT INTO `media_manager` VALUES (51,'Carousel',2,10,0),(52,'Carousel',2,9,1),(54,'Carousel',1,7,0),(59,'Carousel',1,10,1),(60,'Carousel',1,9,2),(61,'Post',15,10,2),(66,'Post',15,8,1),(68,'EventItem',2,9,0),(69,'EventItem',2,8,1),(70,'Post',15,9,0),(71,'EventItem',4,8,0),(72,'EventItem',1,8,0),(73,'EventItem',1,9,1),(74,'Post',4,9,0);
...
INSERT INTO `menu_link` VALUES ('about','main-menu','/site/about','','',1,1,NULL,1544698568,1,1),('bd','admin-menu','/db','settings','',0,43,1544790630,1544790676,1,1),('blog','main-menu','/site/blog','','',0,4,1544699051,1544699051,1,1),('calendar','admin-menu','/event/schedule/fullcalendar','event','',0,31,1547119882,1547328215,1,1),('carousel','admin-menu','/section/carousel/index','landing-page','',0,23,1548703398,1548703398,1,1),('comment','admin-menu','/comment/default/index','','comment',0,10,NULL,NULL,1,NULL),('consult','main-menu','/consult','','',0,3,1545151400,1545151452,1,1),('contact','main-menu','/site/contact','',NULL,1,6,NULL,NULL,1,NULL),('contact-users','admin-menu','/contact/default/index','','users',0,19,1545854511,1545854531,1,1),('dashboard','admin-menu','/','','th',0,0,NULL,NULL,1,NULL),('eav-attribute','admin-menu','/eav/attribute/index','eav',NULL,0,18,NULL,NULL,1,NULL),('eav-eav','admin-menu','/eav/default/index','eav',NULL,0,17,NULL,NULL,1,NULL),('eav-model','admin-menu','/eav/entity-model/index','eav',NULL,0,20,NULL,NULL,1,NULL),('eav-option','admin-menu','/eav/attribute-option/index','eav',NULL,0,19,NULL,NULL,1,NULL),('eav-type','admin-menu','/eav/attribute-type/index','eav',NULL,0,21,NULL,NULL,1,NULL),('event','admin-menu','','','calendar',0,29,1546691552,1546807186,1,1),('event-item','admin-menu','/event/default/index','event','',0,33,1546691606,1547547597,1,1),('event-methods','admin-menu','/event/methods/index','event','',0,37,1546691818,1546806941,1,1),('event-place','admin-menu','/event/place/index','event','',0,34,1546691945,1546807290,1,1),('event-practice','admin-menu','/event/practice/index','event','',0,36,1546691867,1546806955,1,1),('event-programm','admin-menu','/event/programm/index','event','',0,32,1546691999,1546691999,1,1),('event-schedule','admin-menu','/event/schedule/index','event','',0,30,1546692074,1546807163,1,1),('event-vid','admin-menu','/event/vid/index','event','',0,35,1546691902,1546691902,1,1),('feedback','admin-menu','/section/feedback/index','landing-page','',0,28,1549635790,1549635790,1,1),('image-settings','admin-menu','/media/default/settings','settings',NULL,0,41,NULL,NULL,1,NULL),('landing-page','admin-menu','','','sun-o',0,20,1548271267,1548365112,1,1),('media','admin-menu',NULL,'','image',0,6,NULL,NULL,1,NULL),('media-album','admin-menu','/media/album/index','media',NULL,0,8,NULL,NULL,1,NULL),('media-category','admin-menu','/media/category/index','media',NULL,0,9,NULL,NULL,1,NULL),('media-media','admin-menu','/media/default/index','media',NULL,0,7,NULL,NULL,1,NULL),('menu','admin-menu','/menu/default/index','','align-justify',0,11,NULL,NULL,1,NULL),('menu_portfolio','admin-menu','/portfolio/menu/index','portfolio_main','',0,26,1548922544,1548922544,1,1),('page','admin-menu','/page/default/index','','file',0,1,NULL,NULL,1,NULL),('paralax','admin-menu','/section/parallax/index','landing-page','',0,22,1548333227,1548340198,1,1),('portfolio','admin-menu','/portfolio/default/index','portfolio_main','',0,25,1548880921,1548923248,1,1),('portfolio_category','admin-menu','/portfolio/category/index','portfolio_main','',0,27,1548880996,1549574144,1,1),('portfolio_main','admin-menu','/portfolio/default/index','landing-page','',0,24,1548922592,1548923360,1,1),('post','admin-menu','','','pencil',0,2,NULL,1545053615,1,1),('post-category','admin-menu','/post/category/index','post',NULL,0,5,NULL,NULL,1,NULL),('post-post','admin-menu','/post/default/index','post','',0,3,NULL,1545053627,1,1),('post-tag','admin-menu','/post/tag/index','post','',0,4,NULL,1544638544,1,1),('revolution-sliders','admin-menu','/section/slides/index','landing-page','',0,21,1548269000,1549572851,1,1),('seo','admin-menu','/seo/default/index','','line-chart',0,18,NULL,NULL,1,NULL),('settings','admin-menu',NULL,'','cog',0,38,NULL,NULL,1,NULL),('settings-cache','admin-menu','/settings/cache/flush','settings',NULL,0,44,NULL,NULL,1,NULL),('settings-general','admin-menu','/settings/default/index','settings',NULL,0,39,NULL,NULL,1,NULL),('settings-reading','admin-menu','/settings/reading/index','settings',NULL,0,40,NULL,NULL,1,NULL),('settings-translations','admin-menu','/translation/default/index','settings',NULL,0,42,NULL,NULL,1,NULL),('test-page','main-menu','/site/author-course','','',1,2,NULL,1545840778,1,1),('user','admin-menu',NULL,'','user',0,12,NULL,NULL,1,NULL),('user-groups','admin-menu','/user/permission-groups/index','user',NULL,0,16,NULL,NULL,1,NULL),('user-log','admin-menu','/user/visit-log/index','user',NULL,0,17,NULL,NULL,1,NULL),('user-permission','admin-menu','/user/permission/index','user',NULL,0,15,NULL,NULL,1,NULL),('user-role','admin-menu','/user/role/index','user',NULL,0,14,NULL,NULL,1,NULL),('user-user','admin-menu','/user/default/index','user',NULL,0,13,NULL,NULL,1,NULL);
...
INSERT INTO `section_carousel` VALUES (1,'Карусель главная','karusel-main',1,1,1,1,'fadeUp','9000',1,1548704519,1549488366),(2,'Обо мне','karousel-about',1,1,0,0,'fade','9000',1,1549439547,1549547672);
...
CREATE TABLE `section_feedback` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='отзывы посетителей';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `section_feedback` VALUES (1,'Артур Марков','Инженер','<p>Отлично все</p>',1549238400,1549635289,1549635709,1,1);
...
-- Dump completed on 2019-02-08 17:32:38
