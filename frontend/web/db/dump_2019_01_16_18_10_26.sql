...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Связь n:n программы с занятиями';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_programm` VALUES (1,1,1),(2,2,1),(3,3,1),(4,3,2),(5,4,3),(6,2,3);
...
INSERT INTO `event_schedule` VALUES (1,3,4,1,1547532000,1547540100,'23456',1500,0,1547116200,1547478995),(2,3,4,1,1547625000,1547631900,'111',1000,0,1547214300,1547536731),(3,2,3,2,1547531100,1547542800,'',5,0,1547313715,1547503214),(5,1,1,3,1547528400,1547539200,'111',1000,0,1547488584,1547503117),(6,1,1,2,1547613000,1547624700,'',1,0,1547488714,1547648410);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='связь n:n событий в расписании и практик';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_schedule_practice` VALUES (4,6,2),(5,6,1);
...
INSERT INTO `event_schedule_users` VALUES (6,3,2),(7,3,1),(12,1,1),(22,2,2),(25,6,2),(29,6,1),(31,5,2);
...
-- Dump completed on 2019-01-16 18:10:28
