...
--
-- Хост: localhost:3306
-- Время создания: Дек 27 2018 г., 01:04
...
(2, 'Артур', 'artmarkov@mail.ru', 'фке11111', 'происходило автоматическое сохранение данных во все связанные таблицы (вместо того, чтобы делать их сохранение ... Данные сущности Network сохранятся при сохранении самой User, отдельно вызывать save не придется, кроме того, ', 0, 1545854283),
(3, 'Елена', 'artmarkov@mail.ru', 'Привет', 'Привет мирПривет мирПривет мирПривет мирПривет мирПривет мирПривет мирПривет мир', 0, 1545860668);
...
('bd', 'admin-menu', '/db', 'settings', '', 0, 24, 1544790630, 1544790676, 1, 1),
...
('contact-users', 'admin-menu', '/contact/default/index', '', 'users', 0, 999, 1545854511, 1545854531, 1, 1),
...
('image-settings', 'admin-menu', '/media/default/settings', 'settings', NULL, 0, 22, NULL, NULL, 1, NULL),
...
('settings', 'admin-menu', NULL, '', 'cog', 0, 19, NULL, NULL, 1, NULL),
('settings-cache', 'admin-menu', '/settings/cache/flush', 'settings', NULL, 0, 25, NULL, NULL, 1, NULL),
('settings-general', 'admin-menu', '/settings/default/index', 'settings', NULL, 0, 20, NULL, NULL, 1, NULL),
('settings-reading', 'admin-menu', '/settings/reading/index', 'settings', NULL, 0, 21, NULL, NULL, 1, NULL),
('settings-translations', 'admin-menu', '/translation/default/index', 'settings', NULL, 0, 23, NULL, NULL, 1, NULL),
...
(2, 'post_2', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533081600, 1440763228, 1545036343, 1, 1, 3, 'post', 'main'),
(3, 'post_3', 3, 1, 1, '/uploads/2018/12/fishermen-1-400x300.jpg', 1533168000, 1544889352, 1545036356, 1, 1, 7, 'post', 'main'),
(4, 'post_4', 3, 1, 1, '/uploads/2018/12/fishermen-1-400x300.jpg', 1533254400, 1544889352, 1545036375, 1, 1, 2, 'post', 'main'),
(5, 'post_5', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533340800, 1440763228, 1545036386, 1, 1, 1, 'post', 'main'),
(6, 'post_6', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533427200, 1440763228, 1545036397, 1, 1, 1, 'post', 'main'),
(7, 'post_7', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533513600, 1440763228, 1545575251, 1, 1, 1, 'post', 'main'),
(8, 'post_8', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533600000, 1440763228, 1545575244, 1, 1, 1, 'post', 'main'),
(9, 'post_9', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533686400, 1440763228, 1545036435, 1, 1, 1, 'post', 'main'),
(10, 'post_10', 3, 1, 1, '/uploads/2018/12/fishermen-1-400x300.jpg', 1533772800, 1544889352, 1545036444, 1, 1, 2, 'post', 'main'),
(11, 'post_11', 3, 1, 1, '/uploads/2018/12/fishermen-1-400x300.jpg', 1533859200, 1544889352, 1545036451, 1, 1, 2, 'post', 'main'),
(12, 'post_12', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1533945600, 1440763228, 1545036460, 1, 1, 1, 'post', 'main'),
(13, 'post_13', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1534118400, 1440763228, 1545036475, 1, 1, 10, 'post', 'main'),
(14, 'post_14', 2, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1534204800, 1440763228, 1545043839, 1, 1, 11, 'post', 'main'),
(15, 'post_15', 4, 1, 1, '/uploads/2018/12/bridge-1-400x300.jpg', 1534291200, 1440763228, 1545728265, 1, 1, 96, 'post', 'main');
...
(2, 'first-category', 1, 1538934056, 1544781516, 1, 1, 2, 3, 1),
(3, 'second', 1, 1544781484, 1544781484, 1, 1, 4, 5, 1),
(4, 'tretia', 0, 1545053817, 1545053900, 1, 1, 6, 7, 1);
...
(2, 2, 'ru', 'Первая категория', ''),
(3, 3, 'ru', 'Вторая категория', ''),
(4, 4, 'ru', 'Третья категория', ''),
(5, 1, 'ru', 'Корень', '');
...
(1, 'admin', '', '$2y$13$wcW.QP1/o32QF45xIaYre./1fm9YtkYH7CGSigDqDbYgA9jEyxcRK', NULL, 'artmarkov@mail.ru', 10, 0, 1545848406, 1, NULL, '', 1, 'n67FQzYBO4l5nVQ5FJ2i_qYCoP94Mqxl_1545847390', NULL, 'Артур', 'Марков', 1, 4, 1971, 1, '+79055400746', 'artmarkov_skype', ''),
(2, 'ishanova', 'yMdSVV0avEq9xO4p7uO4uCuAeAHpizQc', '$2y$13$G.6gfVKDmWhQsEQuvv2QmuiT/8VRRViJsr3AmXgsVzUtR25Wo/oG2', NULL, 'elenaishanova@mail.ru', 10, 1545848489, 1545848504, 0, '::1', '', 1, NULL, NULL, 'Елена', 'Ишанова', 26, 11, 1978, 2, '', '', '');
