...
CREATE TABLE `event_group` (
  ...
  CONSTRAINT `event_group_ibfk_1` FOREIGN KEY (`programm_id`) REFERENCES `event_programm` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Группы арттерапии';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_group` VALUES (1,1,2,'Первая группа','',1547045378,1547153811),(2,2,1,'Вторая группа','',1547153741,1547153741);
...
DROP TABLE IF EXISTS `event_group_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_group_users` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `event_group_users_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `event_group` (`id`),
  CONSTRAINT `event_group_users_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
/*!40000 ALTER TABLE `event_group_users` DISABLE KEYS */;
INSERT INTO `event_group_users` VALUES (1,1,2),(4,1,1),(5,2,1);
/*!40000 ALTER TABLE `event_group_users` ENABLE KEYS */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Связь n:n программы с занятиями';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_item_programm` VALUES (1,1,1),(2,2,1),(3,3,1),(4,3,2);
...
INSERT INTO `event_place` VALUES (1,'Красный Кит','Россия, Московская область, Красногорск, улица Ленина, 2, 3 этаж','+7 (911) 123 45 67','','artmarkov@mail.ru','Елена','55.81963507238688,37.320560147307866',17,'',1546901535,1546956611);
...
INSERT INTO `event_programm` VALUES (1,2,'Программа 30 встреч','',1547040720,1547148919),(2,1,'Инд Программа','',1547153697,1547153697);
...
CREATE TABLE `event_schedule` (
  ...
  PRIMARY KEY (`id`),
  KEY `event_id` (`item_programm_id`),
  KEY `place_id` (`place_id`),
  CONSTRAINT `event_schedule_ibfk_2` FOREIGN KEY (`place_id`) REFERENCES `event_place` (`id`),
  CONSTRAINT `event_schedule_ibfk_3` FOREIGN KEY (`item_programm_id`) REFERENCES `event_item_programm` (`id`)
...
INSERT INTO `event_schedule` VALUES (1,1,1,1547116200,1547119800,'','1500',0),(2,4,1,1547214300,1547231400,'','1000',0);
...
-- Dump completed on 2019-01-11 17:59:52
