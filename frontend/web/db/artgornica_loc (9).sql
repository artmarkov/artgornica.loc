...
--
-- Хост: localhost:3306
-- Время создания: Мар 11 2019 г., 23:59
...
(2, 1, 145, 1, 1551758400, 1551804000, '', 0, 1551856945, 1552240474),
(3, 1, 3, 2, 1551936900, 1552068300, NULL, 0, 1551874210, 1552237639),
(4, 10, 89, 3, 1552338000, 1552510800, '', 0, 1551876640, 1551955879);
...
('bd', 'admin-menu', '/db', 'settings', '', 0, 47, 1544790630, 1544790676, 1, 1),
...
('event-item', 'admin-menu', '/event/default/index', 'texnics', '', 0, 38, 1546691606, 1547547597, 1, 1),
('event-methods', 'admin-menu', '/event/methods/index', 'texnics', '', 0, 41, 1546691818, 1546806941, 1, 1),
('event-place', 'admin-menu', '/event/place/index', 'event', '', 0, 35, 1546691945, 1546807290, 1, 1),
('event-practice', 'admin-menu', '/event/practice/index', 'texnics', '', 0, 40, 1546691867, 1546806955, 1, 1),
('event-programm', 'admin-menu', '/event/programm/index', '', 'recycle', 0, 36, 1546691999, 1551909697, 1, 1),
('event-schedule', 'admin-menu', '/event/schedule/index', 'event', '', 0, 33, 1546692074, 1546807163, 1, 1),
('event-vid', 'admin-menu', '/event/vid/index', 'texnics', '', 0, 39, 1546691902, 1546691902, 1, 1),
('feedback', 'admin-menu', '/section/feedback/index', 'landing-page', '', 0, 29, 1549635790, 1549635790, 1, 1),
('image-settings', 'admin-menu', '/media/default/settings', 'settings', NULL, 0, 45, NULL, NULL, 1, NULL),
...
('settings', 'admin-menu', NULL, '', 'cog', 0, 42, NULL, NULL, 1, NULL),
('settings-cache', 'admin-menu', '/settings/cache/flush', 'settings', NULL, 0, 48, NULL, NULL, 1, NULL),
('settings-general', 'admin-menu', '/settings/default/index', 'settings', NULL, 0, 43, NULL, NULL, 1, NULL),
('settings-reading', 'admin-menu', '/settings/reading/index', 'settings', NULL, 0, 44, NULL, NULL, 1, NULL),
('settings-translations', 'admin-menu', '/translation/default/index', 'settings', NULL, 0, 46, NULL, NULL, 1, NULL),
('test-page', 'main-menu', '/site/author-course', '', '', 1, 2, NULL, 1545840778, 1, 1),
('texnics', 'admin-menu', '', '', 'th', 0, 37, 1551909416, 1551909521, 1, 1),
...
(2, 'risunki_iz_peska', 11, 1, 0, NULL, 1539129600, 1440763228, 1551362152, 2, 2, 12, 'post', 'main', 1),
