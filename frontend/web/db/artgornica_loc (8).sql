...
--
-- Host: localhost:3306
-- Generation Time: Jan 11, 2019 at 12:39 AM
...
INSERT INTO `event_group` (`id`, `number`, `programm_id`, `name`, `description`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 'Первая группа', '', 1547045378, 1547153811),
(2, 2, 1, 'Вторая группа', '', 1547153741, 1547153741);
...
--
-- Dumping data for table `event_group_users`
--

INSERT INTO `event_group_users` (`id`, `group_id`, `user_id`) VALUES
(1, 1, 2),
(4, 1, 1),
(5, 2, 1);
...
(1, 'Красный Кит', 'Россия, Московская область, Красногорск, улица Ленина, 2, 3 этаж', '+7 (911) 123 45 67', '', 'artmarkov@mail.ru', 'Елена', '55.81963507238688,37.320560147307866', 17, '', 1546901535, 1546956611);
...
CREATE TABLE `event_schedule` (
  ...
  `price` varchar(15) NOT NULL DEFAULT '0' COMMENT 'стоимость занятия',
...
INSERT INTO `event_schedule` (`id`, `item_programm_id`, `place_id`, `start_timestamp`, `end_timestamp`, `description`, `price`, `all_day`) VALUES
(1, 2, 1, 1547116200, 1547119800, '', '1500', 0),
(2, 4, 1, 1547214300, 1547231400, '', '1000', 0);
...
(2, NULL, 'fishermen-1.jpg', 'image/jpeg', '/uploads/2018/12/fishermen-1.jpg', '433390', 'a:3:{s:5:\"small\";s:39:\"/uploads/2018/12/fishermen-1-120x80.jpg\";s:6:\"medium\";s:40:\"/uploads/2018/12/fishermen-1-400x300.jpg\";s:5:\"large\";s:40:\"/uploads/2018/12/fishermen-1-800x600.jpg\";}', 1544817133, 1544817134, 1, 1),
...
(2, 2, 'ru', 'fishermen-1.jpg', 'fishermen-1.jpg', NULL),
...
('calendar', 'admin-menu', '/event/schedule/fullcalendar', 'event', '', 0, 31, 1547119882, 1547119924, 1, 1),
...
('event-item', 'admin-menu', '/event/default/index', 'event', '', 0, 32, 1546691606, 1546807316, 1, 1),
...
(74, 'event', 'ru', 'Занятия'),
(75, 'event-item', 'ru', 'Содержание занятий'),
...
(542, 396, 'ru', 'Название программы'),
(543, 397, 'ru', 'Выберите событие...'),
(544, 398, 'ru', 'Список событий'),
(545, 399, 'ru', 'Выберите программу...'),
(546, 400, 'ru', 'Название программы'),
(547, 401, 'ru', 'Список группы'),
...
ALTER TABLE `event_schedule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `event_id` (`item_programm_id`),
...
ALTER TABLE `event_schedule`
  ...
  ADD CONSTRAINT `event_schedule_ibfk_3` FOREIGN KEY (`item_programm_id`) REFERENCES `event_item_programm` (`id`);
